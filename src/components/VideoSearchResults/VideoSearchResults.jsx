        ...
        <Slider {...settings} className="slick-carousel">
          {preLoaderState ? (
            ...
            apiVideos?.map((video, index) => {
              ...
              const isSaved = savedVideos.find((oneItemFromSavedVideos) => {
               //console.log(oneItemFromSavedVideos);
                return video.youtubeVideoId/*id.videoId*/ === oneItemFromSavedVideos.videoIdForUrl/*.id.videoId*/;
